...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.firstName && user.lastName && user.username && user.password && user.address && user.phoneno && user.role) {
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.phoneno ? ' has-error' : '')}>
                        ...
                        <input type="tel" className="form-control" name="phoneno" value={user.phoneno} onChange={this.handleChange} pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-45-6738"/>
                    </div>
